---
name: unify-workflow-action-constants-v2
overview: 将 WORKFLOW_ACTION 和 WORKFLOW_ACTION_TEXT 常量加入 initSystemConfig 存入 sys_config 表，前后端统一从数据库获取。同时修复 workflowEngine 日志写入的 operatorName/operatorType 问题，以及对齐所有 actionText 映射。
---
